...
from easy_knowledge_retriever.kg.shared_storage import get_storage_keyed_lock
...
async def adelete_by_entity(
    ...
    workspace = entities_vdb.workspace
    ...
    async with get_storage_keyed_lock(
        ...
        try:
            ...
            if relation_chunks_storage is not None and edges:
                ...
                from easy_knowledge_retriever.utils.vector_utils import make_relation_chunk_key
...
async def adelete_by_relation(
    ...
    workspace = relationships_vdb.workspace
    namespace = f"{workspace}:GraphDB" if workspace else "GraphDB"
...
async def _edit_entity_impl(
    ...
    *,
    ...
    if entity_chunks_storage is not None or relation_chunks_storage is not None:
        from easy_knowledge_retriever.utils.vector_utils import make_relation_chunk_key, compute_incremental_chunk_ids
