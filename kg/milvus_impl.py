...
class MilvusVectorDBStorage(BaseVectorStorage):
    def _create_schema_for_namespace(self) -> CollectionSchema:
        ...
        if self.namespace.endswith("entities"):
            ...
            description = "EasyKnowledgeRetriever entities vector storage"
            ...
            description = "EasyKnowledgeRetriever relationships vector storage"
            ...
            description = "EasyKnowledgeRetriever chunks vector storage"
            ...
            description = "EasyKnowledgeRetriever generic vector storage"
        ...
        async with get_data_init_lock():
            ...
            try:
                ...
                if self._client is None:
                    milvus_config = self.global_config.get("storage_config", {}).get(
                        "milvus", {}
                    )

                    uri = milvus_config.get("uri", os.path.join(self.global_config["working_dir"], "milvus_lite.db"))
